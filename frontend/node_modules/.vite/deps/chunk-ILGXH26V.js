...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React20.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React20.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React20.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React20.useState(noSsr || !isMultiSchemes);
  React20.useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  const handleMediaQuery = React20.useCallback((event) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React21.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React21.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React21.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme = React21.useMemo(() => {
      var _a2;
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React21.Fragment, {
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React23.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React24.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React24.Children.map(children, (child) => {
        var _a;
        if (React24.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime14.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types18.default.object.isRequired
} : void 0;
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ILGXH26V.js.map
