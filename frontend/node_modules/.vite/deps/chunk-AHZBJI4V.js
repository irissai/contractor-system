...
import {
  ...
  isFocusVisible
} from "./chunk-PW66J2C6.js";
import {
  Typography_default
} from "./chunk-IHKHGDN3.js";
import {
  memoTheme_default
} from "./chunk-6ZVXOCIG.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React3.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React3.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
function BreadcrumbCollapsed(props) {
  ...
  return (0, import_jsx_runtime5.jsx)("li", {
    children: (0, import_jsx_runtime5.jsx)(BreadcrumbCollapsedButton, {
      focusRipple: true,
      ...otherProps,
      ownerState,
      children: (0, import_jsx_runtime5.jsx)(BreadcrumbCollapsedIcon, {
...
function insertSeparators(items, className, separator, ownerState) {
  return items.reduce((acc, current, index) => {
    if (index < items.length - 1) {
      acc = acc.concat(current, (0, import_jsx_runtime6.jsx)(BreadcrumbsSeparator, {
        "aria-hidden": true,
        className,
        ownerState,
        children: separator
...
var Breadcrumbs = React15.forwardRef(function Breadcrumbs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBreadcrumbs"
  });
  ...
  const renderItemsBeforeAndAfter = (allItems2) => {
    ...
    return [...allItems2.slice(0, itemsBeforeCollapse), (0, import_jsx_runtime6.jsx)(BreadcrumbCollapsed_default, {
  ...
  const allItems = React15.Children.toArray(children2).filter((child) => {
    if (true) {
  ...
  }).map((child, index) => (0, import_jsx_runtime6.jsx)("li", {
    className: classes.li,
    children: child
  }, `child-${index}`));
  return (0, import_jsx_runtime6.jsx)(BreadcrumbsRoot, {
    ref,
    component,
    color: "textSecondary",
    className: clsx_default(classes.root, className),
    ownerState,
    ...other,
    children: (0, import_jsx_runtime6.jsx)(BreadcrumbsOl, {
...
//# sourceMappingURL=chunk-AHZBJI4V.js.map
